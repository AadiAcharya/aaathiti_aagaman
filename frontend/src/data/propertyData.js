...
export const roomsData = [
  {
    ...
    rating: 4.9,
    reviews: 124,
    safety: ["Daily Cleaning", "Fire Extinguishers", "Smoke Detectors", "Disinfections and Sterilizations"],
    reviewsArray: [
      { name: "John Doe", rating: 5, date: "March 15, 2024", comment: "Excellent room with amazing views!" },
      { name: "Sarah Smith", rating: 5, date: "March 10, 2024", comment: "Perfect for our anniversary!" },
    ],
    type: "suite",
    maxGuests: 2,
    bedType: "King",
  ...
  },
  {
    ...
    reviewsArray: [
      { name: "Mike Johnson", rating: 5, date: "March 12, 2024", comment: "Great value for money!" },
      { name: "Emma Wilson", rating: 4, date: "March 5, 2024", comment: "Comfortable beds, good service" },
    ],
    type: "double",
    maxGuests: 4,
    bedType: "Queen",
  ...
  },
  {
    ...
    rating: 5.0,
    reviews: 156,
    safety: ["Daily Cleaning", "Fire Extinguishers", "Smoke Detectors", "Disinfections and Sterilizations", "Security Camera"],
    reviewsArray: [
      { name: "Lisa Anderson", rating: 5, date: "March 20, 2024", comment: "Best ocean views ever! Highly recommend!" },
      { name: "Robert Taylor", rating: 5, date: "March 18, 2024", comment: "Luxury experience at its finest" },
      { name: "Jessica Brown", rating: 5, date: "March 16, 2024", comment: "Worth every penny!" },
    ],
    type: "suite",
    maxGuests: 2,
    bedType: "King",
  ...
  },
  {
    ...
    safety: ["Daily Cleaning", "Fire Extinguishers", "Smoke Detectors"],
    reviewsArray: [
      { name: "Alex Chen", rating: 4, date: "March 14, 2024", comment: "Good value, clean and comfortable" },
      { name: "Maria Garcia", rating: 5, date: "March 10, 2024", comment: "Perfect for solo travel!" },
    ],
    type: "single",
    maxGuests: 1,
    bedType: "Single",
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 142,
    safety: ["Daily Cleaning", "Fire Extinguishers", "Smoke Detectors", "Disinfections and Sterilizations", "First Aid Kit"],
    reviewsArray: [
      { name: "David Martinez", rating: 5, date: "March 19, 2024", comment: "Perfect for family vacation!" },
      { name: "Nancy Lee", rating: 5, date: "March 12, 2024", comment: "Kids loved it, great amenities!" },
    ],
    type: "suite",
    maxGuests: 6,
    bedType: "King + Twin",
  ...
  },
  {
    ...
    safety: ["Daily Cleaning", "Fire Extinguishers", "Smoke Detectors"],
    reviewsArray: [
      { name: "Thomas Wilson", rating: 5, date: "March 18, 2024", comment: "Perfect for business trips, great WiFi!" },
      { name: "Patricia White", rating: 4, date: "March 14, 2024", comment: "Good work space, comfortable bed" },
    ],
    type: "double",
    maxGuests: 2,
    bedType: "Queen",
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 112,
    safety: ["Daily Cleaning", "Fire Extinguishers", "Smoke Detectors", "First Aid Kit"],
    reviewsArray: [
      { name: "Christopher Garcia", rating: 5, date: "March 17, 2024", comment: "Amazing mountain views and fireplace!" },
      { name: "Michelle Brown", rating: 5, date: "March 11, 2024", comment: "Peaceful retreat, love the hot tub" },
    ],
    type: "double",
    maxGuests: 2,
    bedType: "Queen",
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: 95,
    safety: ["Daily Cleaning", "Fire Extinguishers", "Smoke Detectors", "Security Camera"],
    reviewsArray: [
      { name: "James Rodriguez", rating: 5, date: "March 16, 2024", comment: "Modern and stylish, great city views!" },
      { name: "Rachel Green", rating: 4, date: "March 9, 2024", comment: "Good location, comfortable space" },
    ],
    type: "single",
    maxGuests: 1,
    bedType: "Queen",
  ...
  },
  {
    ...
    rating: 4.9,
    reviews: 138,
    safety: ["Daily Cleaning", "Fire Extinguishers", "Smoke Detectors", "Disinfections and Sterilizations", "Lifeguard on duty"],
    reviewsArray: [
      { name: "Jennifer Lee", rating: 5, date: "March 20, 2024", comment: "Beach access is amazing! Perfect getaway!" },
      { name: "Kevin White", rating: 5, date: "March 15, 2024", comment: "Beautiful cottage with everything we needed" },
    ],
    type: "suite",
    maxGuests: 4,
    bedType: "King + Twin",
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: 156,
    safety: ["Daily Cleaning", "Fire Extinguishers", "Smoke Detectors", "Disinfections and Sterilizations", "Security Gate"],
    reviewsArray: [
      { name: "Brandon Scott", rating: 5, date: "March 21, 2024", comment: "Luxury villa experience, loved the garden!" },
      { name: "Rebecca Davis", rating: 5, date: "March 18, 2024", comment: "Perfect for special occasions!" },
    ],
    type: "suite",
    maxGuests: 6,
    bedType: "King + Twin",
