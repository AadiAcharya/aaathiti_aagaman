...
const SignIn = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-background text-text-primary">
      <div className="w-full max-w-md bg-bg-secondary rounded-2xl shadow-lg p-6 space-y-6 border border-gray-700">
        {/* Title */}
        ...
        <div className="flex gap-3 text-text-secondary">
          {/* Country */}
          <div className="flex items-center justify-between border border-gray-700 rounded-lg px-3 py-2 w-1/2 bg-background">
            <div>
          ...
          <div className="w-1/2">
            ...
            <textarea
              ...
              className="w-full border border-gray-700 rounded-lg px-3 py-2 outline-none focus:ring-2 focus:ring-primary bg-background text-text-primary placeholder-text-muted resize-none text-sm"
            />
          </div>
        </div>
        ...
        <div className="space-y-3">
          <button className="w-full bg-primary text-white py-2.5 rounded-lg hover:bg-blue-600 transition">
            Continue
          </button>

          <button className="w-full text-text-secondary flex items-center justify-center gap-2 border border-gray-700 py-2.5 rounded-lg hover:bg-bg-secondary bg-background transition">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="23"
              height="17"
